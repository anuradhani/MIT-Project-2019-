                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-left justify-content-between mb-3">
                            <h1 class="h3 mb-0 text-gray-800"> Proposal Submission</h1>
                        ...
                        <div class="card-header py-3">
                           ...
                           <form action="./model/psubmitmodel.php" method="post" enctype="multipart/form-data">       
