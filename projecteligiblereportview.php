...
<html lang="en">
    ...
    <head>
        ...
        <title>Project Eligible Report View</title>
            ...
            <div class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h2 class="h4 mb-2 text-gray-800">List of Students who are Eligible to Continue the Project</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                ...
                                $result = project_eligibility_report_show();
