...
if (isset($_POST['submit'])) {
    ...
    if (is_uploaded_file($_FILES['fileToUpload']['tmp_name'])) {
       if ($_FILES['fileToUpload']['type'] != "text/csv"){
            ...
            if ($result == 1)
                echo "<script type='text/javascript'>window.onload = function() {if(confirm('Successfully Uploaded the csv file!')==true){window.location.href = '../eligibility_list.php';};};</script> "; 
                echo "<script type='text/javascript'>window.onload = function() {if(confirm('Error occured')==true){window.location.href = '../eligibility_list.php';};};</script> ";
        } #endIF
    } #en
