                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-left justify-content-between mb-3">
                            <h1 class="h3 mb-0 text-gray-800">Progress Report 4-Submission</h1>
                        ...
                        <div class="row"> 
                            ...
                            <form action="./model/preport4model.php" method="post" enctype="multipart/form-data">     
