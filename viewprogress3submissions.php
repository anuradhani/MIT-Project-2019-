...
<html lang="en">
    ...
    <head>
        ...
        include './model/viewprogress3model.php';
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">View Progress Report 3 Submissions</h1>  
                        </div>
                                        ...
                                        <table class="table table-bordered"  width="100%" cellspacing="1">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>" . $Sub_Date . "</td>";
                                                    echo "<td><a href='./files/Progress3/" . $registrationNo . ".pdf'>" . $registrationNo . ".pdf</a></td>";
                        ...
                        <div class="row">
                            <div class="card shadow mb-4 col-md-12">
                                ...
                                <div class="card-body">
                                    <form action="./files/downloadzip_p3.php" method="POST">
