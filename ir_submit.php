                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-left justify-content-between mb-3">
                                <h1 class="h3 mb-0 text-gray-800"> Interim Report Submission</h1>
                            ...
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-primary"> Submission Status</h5>
                                <!-- <br>
                                 <textarea rows="6" cols="100"name="comment" form="usrform" placeholder="Enter text here..."></textarea>
                             </div>
                         </div> -->
                                <br>

                                <form action="./model/irsubmitmodel.php" method="post" enctype="multipart/form-data">    
                                    Select File to Upload:
                                    <input type="file" name="fileToUpload" id="fileToUpload">
                                    <input type="submit" value="Upload File" name="submit" <?php if ($count1 > 0) {
                                            echo 'disabled';
                                        } ?>>
                                </form>
